...
export default function UnderConstructionPage() {
  ...
  useEffect(() => {
    ...
    const spawn = () => {
      ...
      const left = Math.random() * 90 + 5; // 5–95vw
    ...
    spawn(); // immediate first petal
    const iv = setInterval(spawn, 800);
    return () => clearInterval(iv);
  }, []);

  // Blinking hard-hat light
  useEffect(() => {
  ...
  // Pick a stable witty line based on pathname hash or just index 0
  const witty = wittyLines[0];
      ...
      >
        ...
        <main className="relative z-20 flex-1 flex flex-col items-center justify-center px-6 py-16 text-center max-w-sm mx-auto w-full">
          ...
          <div className="fade-up-1 mb-6">
            ...
            >
              {/* Hard-hat emoji with blinking glow dot */}
          ...
          <div className="fade-up-3 mt-5 px-2">
            <p className="text-[13px] text-[var(--color-text-secondary)] leading-relaxed">
              This page is having a glow-up. Our team is sprinkling some magic
          ...
          <p className="fade-up-5 text-[10px] text-[var(--color-text-muted)] mt-6 leading-relaxed">
            * No feelings were harmed in the making of this error page.
          </p>
        </main>
